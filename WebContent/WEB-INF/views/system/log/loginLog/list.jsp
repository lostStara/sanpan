				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:20%" class="center">账号</th>
							<th style="width:35%" class="center">登录IP</th>
							<th style="width:35%" class="center "><i class="icon-time bigger-110 hidden-480"></i>登录时间</th>		
						</tr>
					</thead>
					<tbody></tbody>
				</table>
...
<script src="${jypath}/static/js/system/log/loginLog.js"></script>
</body>
</html>