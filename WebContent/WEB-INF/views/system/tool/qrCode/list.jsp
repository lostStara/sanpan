...
<body>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div id="code">
														<img id="encoderImgId" cache="false" src="${jypath}/static/images/system/2qrcodeDefault.png" width="235px" height="235px" />
													</div>
												</div>
											</div>
										</div>
	...
	<script src="${jypath}/static/js/system/tool/qrcode.js"></script>
</body>
</html>